...
def generate_launch_description():
    ...
    world_file = os.path.join(pkg_better_lidar, 'worlds', 'basic_world.sdf')
    ...
    _process_xacro_model('cylinder')
    _process_xacro_model('sphere')
    _process_xacro_model('box')
    _process_xacro_model('cone')
